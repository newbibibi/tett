...
<body>
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">1:1문의 보기</h1>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		<!-- /.row -->
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">fqnaSelect</div>
					<!-- /.panel-heading -->
					<div class="panel-body">
						<form role="form">
							<div class="form-group" id="actionf">
								<input type="hidden" name="nickname" value="홍길동">
								<input id="qno" type="hidden" name="qno" value="${board.qno }">
							</div>
							...
							<div class="form-group">
								<label>답변</label>
								<textarea class="form-control" rows="5" cols="40" name="answer"
									readonly="readonly">${board.answer }</textarea>
							</div>
				...
				function() {
					...
					$(".btn").click(
							function() {
								...
								if(operation == "remove"){
									formObj.attr("action","/center/cscenter/fqnaRemove")
										.attr("method","get");
