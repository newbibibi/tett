...
<body>
	...
	<form action="${contextPath}/board/modify.do" method="post">
		...
		<div>
			<label for="img">이미지:</label> <input type="file" id="img" name="img"
				onchange="showImagePreview(this)">
		</div>
		<div id="imagePreviewContainer"
			style="${not empty board.img ? 'display: block;' : 'display: none;'}">
			<img id="imagePreview" src="${board.img}"
